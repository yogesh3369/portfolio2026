...
const cardVariants = cva('absolute will-change-transform', {
  variants: {
    variant: {
      dark: 'flex size-full flex-col items-center justify-center gap-6 rounded-2xl border border-stone-700/50 bg-stone-900 p-6 shadow-xl',
      light:
        'flex size-full flex-col items-center justify-center gap-6 rounded-2xl border border-black/10 bg-white p-6 shadow-xl',
    },
  },
  defaultVariants: {
    variant: 'light',
